...
import lightImg from "../imgs/404-light.png"
import darkImg from "../imgs/404-dark.png"
...
const PageNotFound = () => {
    ...
    return (
        <section className="h-cover relative p-10 flex flex-col items-center gap-20 text-center">
            <img src={theme == 'light' ? darkImg : lightImg} className="select-none border-2 border-grey w-72 aspect-square object-cover rounded" />
