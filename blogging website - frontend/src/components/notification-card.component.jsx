...
const NotificationCard = ({ data, index, notificationState }) => {
    ...
    let { user, user: { personal_info: { fullname, username, profile_img } }, blog: { _id, blog_id, title } , type, comment, replied_on_comment, createdAt, _id: notification_id, reply, seen }  = data;
